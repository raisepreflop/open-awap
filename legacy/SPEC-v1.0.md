> **Superseded by v2.0.** This is the original specification (June 2026), kept because
> certificates issued under it must remain readable. Its document-level score made claims
> about a work's origin that no log can observe; v2.0 replaces it with two axes that are
> never summed. New implementations: see [`SPEC.md`](../SPEC.md).
